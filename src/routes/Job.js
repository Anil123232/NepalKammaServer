...
import { createJob, getJob, nearBy, recommendationJobs } from "../domains/jobs/controller/index.js";
...
router.route(`/getRecommendedJob/:id`).get(protect, recommendationJobs);
